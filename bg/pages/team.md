...
redirect_from:
- /bg/people/
- /bg/doc/QubesDevelopers/
- /bg/wiki/QubesDevelopers/
ref: 213
title: Team
translated: 'yes'
---
...
<div id="team-core" class="white-box page-content more-bottom">
      ...
      <div class="row team team-core" id="{{team.name | slugify}}">
        <div class="col-lg-2 col-md-2 col-sm-5 col-xs-12 text-center">
          <div class="picture more-bottom">
            {% if team.picture %}
            <a href="/bg/team/#{{team.name | slugify}}"><img src="/attachment/site/{{team.picture}}" title="Picture of {{team.name}}"></a>
            {% else %}
  ...
  <div class="text-center more-bottom">
    <a href="/bg/join/" class="btn btn-primary"><i class="fa fa-user-plus fa-fw white-icon"></i>Join the team!</a>
  </div>
</div>
...
<div class="white-box page-content more-bottom">
  <div class="col-lg-12 col-md-12 col-sm-12">
    ...
    the <a href="/bg/support/">Qubes mailing lists</a>.</p>
  </div>
  {% for team in site.data.team %}
