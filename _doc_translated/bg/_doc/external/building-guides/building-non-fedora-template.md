...
redirect_from:
- /bg/doc/BuildingNonFedoraTemplate/
- /bg/wiki/BuildingNonFedoraTemplate/
ref: 50
...
Find the .spec file in the git repository (this is the file being used to build rpm packages), and try to adapt it to your OS in order to build a package similar to the target 'vmm-xen'. For example, a PKGBUILD has been created for [ArchLinux](/bg/doc/templates/archlinux/) and can be found in the vmm-xen repository.
