...
true MTA such as [Postfix](/bg/doc/postfix/) or Exim and MRA such as
[Fetchmail](/bg/doc/fetchmail/). Alternatively you can synchronize your mailbox
...
Mutt generally works out of the box. This configuration guide discusses only Qubes-specific setup. In this example we will have one TemplateVM and several AppVMs. It also takes advantage of [SplitGPG](/bg/doc/split-gpg/), which is assumed to be already working.
