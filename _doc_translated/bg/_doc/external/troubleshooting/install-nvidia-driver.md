...
redirect_from:
- /bg/doc/InstallNvidiaDriver/
- /bg/wiki/InstallNvidiaDriver/
ref: 47
...
[Hardware Compatibility List (HCL)](/bg/doc/hcl/#generating-and-submitting-new-reports )
...
See [this page](/bg/doc/copy-to-dom0/) for instructions on how to transfer files to Dom0 (where there is normally no networking).
