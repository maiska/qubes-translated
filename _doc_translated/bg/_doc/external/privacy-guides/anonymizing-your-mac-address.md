...
redirect_from:
- /bg/doc/randomizing-your-mac-address/
ref: 61
...
Network Manager 1.4.2 or later is available from the Fedora 25 repository as well as the Debian 9 repository, which you can install by [upgrading a Debian 8 template to version 9.](/bg/doc/debian-template-upgrade-8/) 
...
![Edit Connection](/bg/attachment/wiki/RandomizeMAC/networkmanager-mac-random.png)
