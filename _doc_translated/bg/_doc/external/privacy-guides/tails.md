...
1.  Read about [creating and using HVM qubes](/bg/doc/hvm/)
...
### Security
You will probably want to implement [MAC spoofing](/bg/doc/anonymizing-your-mac-address/).
