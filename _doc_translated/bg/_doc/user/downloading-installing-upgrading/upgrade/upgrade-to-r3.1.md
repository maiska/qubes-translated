...
redirect_from:
- /bg/doc/UpgradeToR3.1/
- /bg/doc/UpgradeToR3.1rc1/
ref: 128
...
found [here](/bg/doc/software-update-vm/). The steps described in this
...
[User FAQ](/bg/faq/#i-created-a-usbvm-and-assigned-usb-controllers-to-it-now-the-usbvm-wont-boot)
for details.
