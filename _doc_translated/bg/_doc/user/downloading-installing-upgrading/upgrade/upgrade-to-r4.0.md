...
redirect_from:
- /bg/doc/UpgradeToR4.0/
- /bg/doc/UpgradeToR4.0rc1/
ref: 130
...
5. Follow the **Restoring from a Backup** section in the [Backup, Restoration, and Migration](/bg/doc/backup-restore/) guide.
   We recommend that you restore only your [TemplateBasedVMs](/bg/doc/glossary/#templatebasedvm) and [StandaloneVMs
   ...
   Instead, we recommend using the TemplateVMs that were created specifically for R4.0, which you can [customize](/bg/doc/software-update-vm/) according to your needs.
