...
redirect_from:
- /bg/doc/FullScreenMode/
- /bg/wiki/FullScreenMode/
ref: 96
...
Normally Qubes GUI virtualization daemon restricts the VM from "owning" the full screen, ensuring that there are always clearly marked decorations drawn by the trusted Window Manager around each of the VMs window. This allows the user to easily realize to which domain a specific window belongs. See the [screenshots](/bg/doc/QubesScreenshots/) for better understanding.
