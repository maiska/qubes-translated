...
redirect_from:
- /bg/doc/dispvm/
- /bg/doc/DisposableVms/
- /bg/wiki/DisposableVMs/
ref: 91
title: DisposableVMs
translated: 'yes'
---
...
![r1-open-in-dispvm-1.png](/bg/attachment/wiki/DisposableVms/r1-open-in-dispvm-1.png) ![r1-open-in-dispvm-2.png
...
![r1-open-in-dispvm-3.png](/bg/attachment/wiki/DisposableVms/r1-open-in-dispvm-3.png)
...
Full instructions can be found [here](/bg/doc/disposablevm-customization/).


[DisposableVM Template]: /bg/doc/glossary/#disposablevm-template