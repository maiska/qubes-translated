...
<hr class="add-top more-bottom">
  <div class="row more-bottom">
    <div class="col-lg-4 col-md-4 col-xs-12">
      ...
      <a href="/bg/video-tours/" class="btn btn-primary">
    ...
    <div class="col-lg-4 col-md-4 col-xs-12">
      ...
      <a href="/bg/screenshots/" class="btn btn-primary">
    ...
    <div class="col-lg-4 col-md-4 col-xs-12">
      ...
      <a href="/bg/getting-started/" class="btn btn-primary">
