...
redirect_from:
- /bg/doc/qubes-architecture/
- /bg/doc/QubesArchitecture/
- /bg/wiki/QubesArchitecture/
ref: 168
title: Architecture
translated: 'yes'
---
...
[![qubes-arch-diagram-1.png](/bg/attachment/wiki/QubesArchitecture/qubes-arch-diagram-1.png)
...
[Architecture Spec v0.3 [PDF]](/bg/attachment/wiki/QubesArchitecture/arch-spec-0.3.pdf) (The original 2009 document that started this all...)